...
import re
import os
import OCRtest, checklistGevarenTestomgeving, navigatieTestomgeving #Andere python files.
...
def start():
    ...
    aantalRecords = OCRtest.retrieveAantalRecords()
