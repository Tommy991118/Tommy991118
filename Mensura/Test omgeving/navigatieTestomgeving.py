...
def openhw():
    ...
    time.sleep(1)
    #Openen H@W
    #py.click(x=41, y=229, clicks=2) #Echte omgeving
    py.click(x=115, y=349, clicks=2) #Test omgeving
    ...
    #Tijd geven om manueel de bedrijfsbezoeken te sorteren.
    time.sleep(10)
...
def openVerslag(Y, i, aantalRecords):
    ...
    time.sleep(1)
    if OCRtest.checkAanwezigheidGevarenlijst() == True:
        time.sleep(1)
    ...
    if OCRtest.checkAanwezigheidVerslag() == True:
...
def bedrijfsbezoekNoteren():
    ...
    bedrijfsbezoek = OCRtest.retrieveBedrijfsbezoek() #Referentie van het bedrijfsbezoek extraheren uit H@W.
